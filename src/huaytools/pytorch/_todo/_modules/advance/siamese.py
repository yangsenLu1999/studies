...
from huaytools.pytorch._todo._modules import DualNet
from huaytools.pytorch._todo._backend.distance_fn import euclidean_distance
...
def _test():
    ...
    def _test_bert():
        """"""
        from huaytools.pytorch._todo._modules import get_bert_pretrained
