...
from huaytools.pytorch._todo._backend.distance_fn import euclidean_distance_nosqrt
from huaytools.pytorch._todo._modules.loss._base import BaseLoss
...
def triplet_loss(anchor, positive, negative, distance_fn=F.pairwise_distance, margin=2.0):
    ...
    Examples:
        ...
        >>> from huaytools.pytorch.backend import cosine_distance
